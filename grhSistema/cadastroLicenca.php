...
if ($acesso) {
    ...
    $objeto->set_campos(array(
        ...
        array('linha' => 2,
            'col' => 3,
            'nome' => 'pericia',
            'title' => 'Caso o afastameanto necessita de perícia',
            'helptext' => 'Caso o afastameanto necessita de perícia',
            'label' => 'Perícia:',
            'tipo' => 'combo',
            'array' => array("Sim", "Não"),
            'size' => 10),
        array('linha' => 2,
            'col' => 3,
            'nome' => 'publicacao',
            'title' => 'Caso o afastameanto necessita de publicação',
            'helptext' => 'Caso o afastameanto necessita de publicação',
            'label' => 'Publicação:',
            'tipo' => 'combo',
            'array' => array("Sim", "Não"),
            'size' => 10),
        array('linha' => 2,
            'col' => 3,
            'nome' => 'processo',
            'title' => 'Caso o afastameanto necessita de processo',
            'helptext' => 'Caso o afastameanto necessita de processo',
            'label' => 'Processo:',
            'tipo' => 'combo',
            'array' => array("Sim", "Não"),
            'size' => 10),
        array('linha' => 3,
            'col' => 3,
            'nome' => 'dtPeriodo',
            'title' => 'Caso o afastameanto necessita de período aquisitivo',
            'helptext' => 'Caso o afastameanto necessita de período aquisitivo',
