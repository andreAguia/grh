...
if ($acesso) {
    ...
    $relatorio->set_titulo("Relatório de Docentes que Saíram em {$relatorioAno}");
    $relatorio->set_subtitulo('Ordenados pelo Nome');
    $relatorio->set_label(array("Matrícula", "Nome", "CPF", "Email", "Saída", "Situação"));
    ...
    $relatorio->set_metodo(array(null, null, null, "get_emails", null, "get_situacao"));
