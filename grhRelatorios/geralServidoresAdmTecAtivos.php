...
{    
    ...
    $relatorio->set_titulo('Relatório Geral de Servidores Administrativos e Técnicos Ativos');
    ...
    $relatorio->set_metodo(array(NULL,NULL,"get_CargoSimples","get_Lotacao",NULL,NULL,"get_Situacao"));
