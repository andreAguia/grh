...
if ($acesso) {
    ...
    # Caminhos
    $objeto->set_linkIncluir('?fase=incluir'); // Muda o link de incluir excepcionalmente nesse caso por causa da session do id
    ...
    if (!empty($id)) {
        ...
        $botao->set_url("cadastroPlanoCargosUpload.php?fase=upload&id={$id}");
