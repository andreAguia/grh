...
{    
    ...
    $relatorio->set_label(array('Matrícula','Id','Nome','Lotação','Ano','Dt Inicial','Dias','Dt Final','Status','Assinatura'));
    $relatorio->set_width(array(5,5,30,20,5,9,8,9,10,10));
