...
if ($acesso) {
    ...
    # Assunto
    $assunto = "Renovação da Redução de Carga Horária de " . $nomeServidor;

    # Monta a CI
    $ci = new Ci($numCiInicio, $dtCiInicio, $assunto);
    $ci->set_destinoNome($chefe);
    $ci->set_destinoSetor($cargo);
    $ci->set_texto("Vimos informar a concessão da renovação da <b>Redução de Carga Horária</b> do(a) servidor(a) <b>" . strtoupper($nomeServidor) . "</b>,"
