...
if ($acesso) {
    ...
    $relatorio->set_titulo('Relatório de Docentes Ativos Com Vaga de Concurso');
    $relatorio->set_subtitulo('Agrupados por Lotação - Ordenados pelo Nome');
    $relatorio->set_label(array('IdFuncional', 'Nome', 'Cargo', 'Lotação', 'Perfil', 'Admissão', 'Saída', 'Vaga'));
