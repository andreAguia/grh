...
if ($acesso) {
    ...
    $objeto->set_rotinaExtraEditarParametro("Importante ressaltar que o que for escrito nas Observações"
            . " irá aparecer na ficha cadastral, junto as informações de triênio.");

    # Pega o perfil do Servidor    
    $perfilServidor = $pessoal->get_idPerfil($idServidorPesquisado);

    # Nome do Modelo (aparecerá nos fildset e no caption da tabela)
    $objeto->set_nome("Observações de Triênio");

    # select do edita
    $selectEdita = "SELECT obsTrienio
                      FROM tbservidor
    ...
    $objeto->set_linkListar('servidorTrienio.php');

    # botão voltar
    $objeto->set_voltarForm('servidorTrienio.php');
    ...
    $campos = array(array('linha' => 1,
            ...
            'size' => array(80, 4),
            'autofocus' => true,
            'title' => 'Observação sobre todos os triênios deste servidor.'));
