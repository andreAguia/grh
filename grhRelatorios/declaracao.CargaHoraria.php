    ...
    if ($idPerfil == 1) {
        ...
        if ($idLotacao <> 113) {
            $dec->set_texto("Declaro para os devidor fins que {$texto1} <b>" . strtoupper($nomeServidor) . "</b>,"
                    ...
                    . " horária de 40 horas semanais, de 8 h às 18 h, de segunda à sexta, com 2 h de intervalo.");
        } else {
            $dec->set_texto("Declaro para os devidor fins que {$texto1} <b>" . strtoupper($nomeServidor) . "</b>,"
        ...
        if ($idLotacao <> 113) {
            $dec->set_texto("Declaro para os devidor fins que {$texto1} <b>" . strtoupper($nomeServidor) . "</b>,"
                    ...
                    . " normalmente sua carga horária de 40 horas semanais, de 8 h às 18 h, de segunda à sexta, com 2 h de intervalo.");
        } else {
            $dec->set_texto("Declaro para os devidor fins que {$texto1} <b>" . strtoupper($nomeServidor) . "</b>,"
