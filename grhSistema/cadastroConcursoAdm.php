...
################################################################
    ...
    switch ($fase) {
        ...
        case "listaServidoresAtivos" :
            ...
            # email
            $botao2 = new Link("Emails", "?fase=email");
        ...
        case "aguardaListaServidoresAtivosLotacao" :
            ...
            # menu
            $concurso->exibeMenu($idConcurso, "Servidores Ativos - Lotação");
            ...
            loadPage('?fase=listaServidoresAtivosLotacao');
            break;

        case "listaServidoresAtivosLotacao" :
            ...
            # Formulário
            $form = new Form('?fase=aguardaListaServidoresAtivosLotacao');
        ...
        case "duplicados" :
            ...
            if ($idConcurso == 96) {
                ...
                mensagem("Sem Informação Para Este Concurso", "Candidatos Duplicados");
            }
...
//            $relatorio->set_grupoCorColuna(0);
        ...
        case "email" :
           # Limita o tamanho da tela
            ...
            # menu
            $concurso->exibeMenu($idConcurso, "Servidores Ativos - Emails");
