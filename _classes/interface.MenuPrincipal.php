...
class MenuPrincipal {
    ...
    private function moduloDocumentos() {
        ...
        $botao->set_url('https://drive.google.com/drive/folders/1-ysYBCiM0gBUVlOlssT17flpX6SHqpEI?usp=drive_link');
    ...
    private function moduloTabelaAuxiliares() {
        ...
        $botao->set_url('cadastroFuncao.php?grh=1');
...
//        $menu->add_item($botao);
        ...
        $botao->set_url('areaAvaliacaoProcesso.php?grh=1');
