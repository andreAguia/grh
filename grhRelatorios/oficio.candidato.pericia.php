...
if ($acesso) {
    ...
    $oficio->set_texto("Tenho a honra de encaminhar a V.S.ª, o(a) candidato(a) {$dados['nome']}, RG nº {$dados['identidade']} Detran RJ, CPF {$dados['cpf']}, aprovado(a) em Concurso Público da Universidade Estadual do Norte Fluminense Darcy Ribeiro (UENF), para a realização de exame médico admissional no dia {$data} às {$hora} horas, na Rua Silva Jardim, 31 – Praça Tiradentes – Centro - Rio de Janeiro/RJ tel.(21) 2332-6526.");
    $oficio->set_texto("O referido exame é requisito indispensável ao processo de admissão no cargo de {$dados['cargo']}, do Quadro Permanente desta Universidade, vinculada à Secretaria de Estado de Ciência, Tecnologia e Inovação do Rio de Janeiro.");
