...
if ($acesso) {
    ...
    $objeto->set_campos(array(
        ...
        array('linha' => 3,
            'col' => 3,
            'nome' => 'limite_sexo',
            'title' => 'Caso o afastameanto é limitada a servidores de algum sexo',
            'helptext' => 'Caso o afastameanto é limitada a servidores de algum sexo',
        ...
        array('linha' => 3,
            'col' => 3,
            'nome' => 'tempoServico',
            'title' => 'Caso o afastameanto interrompe a contagem do tempo de serviço',
            'helptext' => 'Caso o afastameanto interrompe a contagem do tempo de serviço',
