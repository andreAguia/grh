...
if ($acesso) {
    ...
    # select da lista
    $objeto->set_selectLista("SELECT idCandidatoSituacao,
                                     situacao,
                                     obs
    ...
    $objeto->set_label(["Id", "Situação", "Obs"]);
    $objeto->set_width([5, 20, 70]);
    $objeto->set_align(["center", "left", "left"]);

//    $objeto->set_classe([null, null, null, "Pessoal"]);
//    $objeto->set_metodo([null, null, null, "get_servidoresSituacao"]);
    # Classe do banco de dados
    $objeto->set_classBd('Pessoal');

    # Nome da tabela
    $objeto->set_tabela('tbcandidatosituacao');

    # Nome do campo id
    $objeto->set_idCampo('idCandidatoSituacao');
