...
if ($acesso) {
    ...
    switch ($fase) {
        ...
        case "abono";
            ...
            $menu->add_item('linkWindow', 'Relatório Geral de Estatutarios - com Abono Permanencia Deferido - Ordenado por Processo', '../grhRelatorios/abonoPermanencia.geral.deferido.porProcesso.php');
...
//            $menu->show();
        ...
        case "financeiro";
            ...
            $menu->add_item('linkWindow', 'Relatório de Estatutarios Com Faixa e Nivel do Plano de Cargos - Por Lotação', '../grhRelatorios/financeiro.porLotacao.php');
            $menu->add_item('linkWindow', 'Relatório de Estatutarios Com Faixa e Nivel do Plano de Cargos', '../grhRelatorios/financeiro.geral2.php');
        ...
        case "geralAtivos";
            ...
            $menu->add_item('linkWindow', 'Relatório Geral de Servidores Ativos - Email - Agrupados por Diretoria / Centro', '../grhRelatorios/geral.servidores.ativos.comEmail.porDiretoria.php');
            ...
            $menu->add_item('linkWindow', 'Relatório Geral de Servidores Ativos - 3 Assinaturas', '../grhRelatorios/geral.servidores.ativos.assinatura2.php');            
