...
################################################################
    ...
    switch ($fase) {
        ...
        case "listaCandidatos" :
            ...
            $menu->add_item('linkWindow', 'Com E-mail', '?fase=relatorio10');
        ...
        case "relatorio1":
            ...
            /*
             *  Candidatos de um cargo com CPF, email e telefone
             */
        ...
        case "relatorio2":
            ...
            /*
             *  Candidatos de um cargo com cpf, identidade, nascimento e pontuação
             */
            if ($parametroCargoCandidato <> "*") {
        ...
        case "relatorio3":
            ...
            /*
             *  Candidatos de um cargo somente com a pontuação
             */
            if ($parametroCargoCandidato <> "*") {
        ...
        case "relatorio4":
            ...
            /*
             *  Para a Perícia
             *  Todos os Candidatos Aprovados de Todos os cargos
...
//            });
        ...
        case "editaCandidato" :
            ...
            # Informa a origem
            set_session('origem', "cadastroCandidatosAdm2025PorCargo.php");
        ...
        case "editaCandidatoDuplicado" :
            ...
            # Informa a origem
            set_session('origem', "cadastroCandidatosAdm2025PorCargo.php?fase=duplicados");
