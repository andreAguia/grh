...
if ($acesso) {
    ...
    $relatorio->set_titulo('Cartão de Frequência Mensal');
    $relatorio->set_tituloLinha2("{$mes[0][0]} / {$anoBase}");
    ...
    $relatorio->set_logDetalhe("Visualizou a Folha de Presença Mensal de {$mes} / {$anoBase}");
    $relatorio->show();
