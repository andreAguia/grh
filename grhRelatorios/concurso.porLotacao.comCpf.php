...
if ($acesso) {
    ...
    $select = 'SELECT tbservidor.idFuncional,
                     ...
                     dtAdmissao,
                     tbdocumentacao.cpf,
                     CONCAT("(",IFnull(tbpessoa.telCelularDDD,""), ") - ", IFnull(tbpessoa.telCelular,""))
    ...
    $relatorio->set_label(['IdFuncional', 'Nome', 'Cargo', 'Lotação', 'Admissão', 'CPF', 'Tel Celular']);
    $relatorio->set_width([10, 25, 25, 0, 10, 10, 15]);
