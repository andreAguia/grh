...
class AposentadoriaTransicao1 {
    ...
    public function exibeAnalise() {
        ...
        if (strtotime(date_to_bd($dtIngressoServidor)) < strtotime(date_to_bd($this->dtIngresso))) {
            ...
            $analiseIngresso = "Não pode solicitar essa opção";
        }
        ...
        callout("ART. 6º. DA EC Nº. 41/2003<br/>É o benefício concedido aos servidores "
                . "titulares de cargos efetivos que ingressaram no serviço público até "
                . "31 de dezembro de 2003 e que preenchem, cumulativamente, os seguintes"
                . " requisitos:");
