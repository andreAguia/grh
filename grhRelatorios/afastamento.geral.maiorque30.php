...
if ($acesso) {
    ...
    # Define a quantidade de dias
    $dias = 30;

    # Começa uma nova página
    $page = new Page();
    $page->set_title("Servidores com Mais de {$dias} Dias de Afastamento");
    $page->iniciaPagina();
    ...
    $relatorio->set_titulo("Relatório de Servidores com Mais de {$dias} Dias de Afastamento");
