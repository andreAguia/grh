...
if ($acesso) {
    ...
    $mensagem = " - Toda alteração de lotação de servidor deverá ser informada aos administradores do SEI na Uenf através do e-mail sei@uenf.br"
    ...
    switch ($fase) {
        case "" :
        case "listar" :
            $objeto->set_rotinaExtraListar("calloutWarning");
