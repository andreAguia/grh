...
if ($acesso) {
    ...
    $relatorio->set_titulo('Relatório Geral de Professores Ativos');
    ...
    $relatorio->set_classe(array(null, null, null, "pessoal", null, null, "pessoal"));
    $relatorio->set_metodo(array(null, null, null, "get_Lotacao", null, null, "get_Situacao"));
