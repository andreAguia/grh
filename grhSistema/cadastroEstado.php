...
{    
    ...
    # select da lista
    $objeto->set_selectLista ('SELECT idEstado,
                                      nome,
                                      uf
                                 FROM tbestado
                                WHERE nome LIKE "%'.$parametro.'%"
                                   OR uf LIKE "%'.$parametro.'%"  
    ...
    $objeto->set_label(array("Id","Estado","UF"));
    ...
    # Nome da tabela
    $objeto->set_tabela('tbestado');

    # Nome do campo id
    $objeto->set_idCampo('idEstado');
