...
if ($acesso) {
    ...
    if ($fase <> "aguardeGeralPorLotacao" AND $fase <> "geralPorLotacao") {
        ...
        $botao1 = new Link("Aposentados por Ano", "?fase=aguardePorAno");
        $botao1->set_class('button');
        $menu->add_link($botao1, "right");
        
        $botao1 = new Link("Aposentados por Tipo", "?fase=aguardePorTipo");
        $botao1->set_class('button');
        $menu->add_link($botao1, "right");
        
        $botao1 = new Link("Previsão", "?fase=aguardeGeralPorLotacao");
        $botao1->set_class('button');
        $menu->add_link($botao1, "right");
