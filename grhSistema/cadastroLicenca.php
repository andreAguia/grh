...
if ($acesso) {
    ...
    $objeto->set_campos(array(
        ...
        array('linha' => 2,
            'col' => 3,
            'nome' => 'pericia',
            'title' => 'Caso o afastameanto necessite de perícia',
            'helptext' => 'Caso o afastameanto necessite de perícia',
            'label' => 'Perícia:',
            'tipo' => 'combo',
            'array' => array("Sim", "Não"),
            'size' => 10),
        array('linha' => 2,
            'col' => 3,
            'nome' => 'publicacao',
            'title' => 'Caso o afastameanto necessite de publicação',
            'helptext' => 'Caso o afastameanto necessite de publicação',
            'label' => 'Publicação:',
            'tipo' => 'combo',
            'array' => array("Sim", "Não"),
            'size' => 10),
        array('linha' => 2,
            'col' => 3,
            'nome' => 'processo',
            'title' => 'Caso o afastameanto necessite de processo',
            'helptext' => 'Caso o afastameanto necessite de processo',
            'label' => 'Processo:',
            'tipo' => 'combo',
            'array' => array("Sim", "Não"),
            'size' => 10),
        array('linha' => 3,
            'col' => 3,
            'nome' => 'dtPeriodo',
            'title' => 'Caso o afastameanto necessite de período aquisitivo',
            'helptext' => 'Caso o afastameanto necessite de período aquisitivo',
        ...
        array('linha' => 3,
            'col' => 3,
            'nome' => 'limite_sexo',
            'title' => 'Caso o afastameanto seja limitado a servidores de algum sexo',
            'helptext' => 'Caso o afastameanto seja limitado a servidores de algum sexo',
        ...
        array('linha' => 3,
            'col' => 3,
            'nome' => 'tempoServico',
            'title' => 'Caso o afastameanto interrompa a contagem do tempo de serviço',
            'helptext' => 'Caso o afastameanto interrompa a contagem do tempo de serviço',
