...
if ($acesso) {
    ...
    $objeto->set_campos(array(
        ...
        array('linha' => 2,
            'col' => 3,
            'nome' => 'pericia',
            'title' => 'informa se esse afastameanto necessita de perícia',
            'helptext' => 'informa se esse afastameanto necessita de perícia',
            'label' => 'Perícia:',
            'tipo' => 'combo',
            'array' => array("Sim", "Não"),
            'size' => 10),
        array('linha' => 2,
            'col' => 3,
            'nome' => 'publicacao',
            'title' => 'informa se esse afastameanto necessita de publicação',
            'helptext' => 'informa se esse afastameanto necessita de publicação',
            'label' => 'Publicação:',
            'tipo' => 'combo',
            'array' => array("Sim", "Não"),
            'size' => 10),
        array('linha' => 2,
            'col' => 3,
            'nome' => 'processo',
            'title' => 'informa se esse afastameanto necessita de processo',
            'helptext' => 'informa se esse afastameanto necessita de processo',
            'label' => 'Processo:',
            'tipo' => 'combo',
            'array' => array("Sim", "Não"),
            'size' => 10),
        array('linha' => 3,
            'col' => 3,
            'nome' => 'dtPeriodo',
            'title' => 'informa se esse afastameanto necessita de período aquisitivo',
            'helptext' => 'informa se esse afastameanto necessita de período aquisitivo',
        ...
        array('linha' => 3,
            'col' => 3,
            'nome' => 'limite_sexo',
            'title' => 'informa se esse afastameanto é limitada a servidores de algum sexo',
            'helptext' => 'informa se esse afastameanto é limitada a servidores de algum sexo',
        ...
        array('linha' => 3,
            'col' => 3,
            'nome' => 'tempoServico',
            'title' => 'informa se esse afastameanto interrompe a contagem do tempo de serviço',
            'helptext' => 'informa se esse afastameanto interrompe a contagem do tempo de serviço',
